                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($meetingMinute->file_path)
                                            ...
                                            @endphp
                                            <img src="{{ $imageUrl }}" alt="{{ $meetingMinute->title }}" 
                ...
                <form action="{{ route('meeting_minutes.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body small text-muted">
                        <div class="mb-3">
                            ...
                            <input type="file" name="image" id="addMeetingMinutesImage" class="form-control form-control-sm" accept="image/*">
            ...
            <div class="modal-content rounded border-0 shadow-sm">
                <form id="editMeetingMinutesForm" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                    ...
                    <div class="modal-body small text-muted">
                        ...
                        <div class="mb-3">
                            <label class="form-label small">Image (Optional)</label>
                            <input type="file" name="image" id="editMeetingMinutesImage" class="form-control form-control-sm" accept="image/*">
                            <div class="invalid-feedback">Please select a valid image file.</div>
...
@section('scripts')
    <script>
        ...
        $('#editMeetingMinutesModal').on('show.bs.modal', function (event) {
            ...
            if (image_path) {
                var imagePath = image_path.replace('public/', '');
                existingImageInput.val(image_path);
                currentPreview.attr('src', '{{ asset("") }}' + imagePath).show();
            } else {
