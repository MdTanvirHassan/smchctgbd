                    ...
                    <div class="col-md-4">
                        <form action="{{ route('department.store') }}" method="POST">
                            ...
                            <div class="border-0 mb-4">
                                <h6 class="text-muted fw-semibold" id="addNoticeModalLabel">Add New Department</h6>
                            </div>
                            <div class="mb-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <button type="button" class="btn btn-soft-primary btn-sm rounded-2"
                                                    ...
                                                    data-action="{{ route('department.update', $department->id) }}"
                                                    data-name="{{ $department->name }}" title="Edit">
    ...
    <script>
        $(document).ready(function () {
            $('#editDepartmentModal').on('show.bs.modal', function (event) {
                ...
                $('#editDepartmentForm').attr('action', actionUrl);
                $('#edit_name').val(name);
            });
        });
    </script>
